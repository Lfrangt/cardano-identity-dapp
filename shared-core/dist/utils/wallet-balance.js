...
exports.parseWalletBalance = parseWalletBalance;
exports.formatADA = formatADA;
 ...
 */
function bigIntToAdaString(lovelaceAmount) {
 ...
 * 解析钱包余额
 */
function parseWalletBalance(balanceHex) {
    try {
        // 解析 CBOR 编码的余额
