...
exports.checkIPFSExists = checkIPFSExists;
exports.getIPFSSetupGuide = getIPFSSetupGuide;
const platform_1 = require("../utils/platform");
/**
 * 上传文件到 IPFS (使用 NFT.Storage)
 */
async function uploadToIPFS(file, fileName = 'file') {
    try {
 ...
 * 使用 Pinata 上传文件
 */
async function uploadToPinata(file, fileName, apiKey, apiSecret) {
    try {
 ...
 * 使用 NFT.Storage 上传文件
 */
async function uploadToNFTStorage(file, fileName, apiKey) {
    try {
...
async function simulateIPFSUpload(file) {
    ...
    const hashArray = Array.from(await (0, platform_1.sha256)(arrayBuffer));
